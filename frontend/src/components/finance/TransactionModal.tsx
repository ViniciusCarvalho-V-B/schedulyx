              ...
              <section>
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <div className="flex rounded-xl bg-surface-container p-1 border border-border">
                      <button 
                        type="button" 
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <select 
                      name="category" 
                      id="category"
                      className="custom-input block w-full rounded-xl border border-border bg-surface-container-low text-white focus:ring-1 focus:ring-primary focus:border-primary sm:text-sm transition-colors py-2.5 px-3"
                    >
